...
var BASE_URL = 'https://---.com';
var initDesktopLoadData = [
  new MenuItem('Mail', 'snail', BASE_URL + 'mail-icon.png'),
  new MenuItem('Email', 'email', BASE_URL + '/email-icon.png'),
  new MenuItem('Text', 'text', BASE_URL + '/sms-icon.png'),
  new MenuItem('Print', 'print', BASE_URL + /print-icon.png')
];
